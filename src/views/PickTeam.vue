    ...
    <div class="pickteam">
        ...
        <div class="container-fluid my-5">
            ...
            <div class="row">
                ...
                <p v-if="buildField == true" class="text-center text-uppercase hidden-appear-text alert" style="color:#16b37c">
                ...
                <div v-if="buildField">
                    <div class="player-select-holder"> 
                        ...
                        :style="selectedPlayers.gk == player ? 'opacity: 0.5; pointer-events: none' : 'unpicked'"
                        ...
                        <div v-if="buildField == true">
                            <div class="row">
                                <div class="col text-center pos">
                                    ...
                                    <div class="player-img">
                                        <span class="remove-player" v-if="formations.gk" @click="removePlayer(0, 'gk')">
                                            <i class="fa fa-times"></i>
                                        </span> 
                                    <img src="../assets/images/black.png" class="img-fluid" alt="player icon" @click="showPlayers('gk')">
                                    </div>
                            ...
                            <div class="row player-row">
                                <div class="col text-center pos" v-for="(number, index) in formations.defender.amount" :key="number.id">
                                    ...
                                    <img src="../assets/images/black.png" class="img-fluid" alt="player icon" @click="showPlayers('def')">
                                    </div>
                                    <div class="player-info my-1">
                            ...
                            <div class="row player-row">
                                <div class="col text-center pos" v-for="(number, index) in formations.midfielders.amount" :key="number.id">
                                    ...
                                    <img src="../assets/images/black.png" class="img-fluid" alt="player icon" @click="showPlayers('mid')">
                                    </div>
                                    <div class="player-info my-1">
                            ...
                            <div class="row player-row">
                                <div class="col text-center pos" v-for="(number, index) in formations.attackers.amount" :key="number.id">
                                    ...
                                    <img src="../assets/images/black.png" class="img-fluid" alt="player icon" @click="showPlayers('fwd')">
                                    </div>
                                    <div class="player-info my-1">
...
export default {
    ...
    methods:{
        getPlayers(){
            axios.get("http://lfl-app.herokuapp.com/api/displayplayers/")
            .then(response=> {
        ...
        selectPlayer(player) {
            ...
            let combinedArray = [...this.selectedPlayers.defender.players, ...this.selectedPlayers.midfielders.players, ...this.selectedPlayers.attackers.players]
            const countPlayers = (value, arr) => arr.filter(x => x.team === value).length;
